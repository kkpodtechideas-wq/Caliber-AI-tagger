...
│  + Tag Cleanup   │                │  https://books.kkpod.dev │
│                  │                │                          │
│  ~/Desktop/      │                │  ~/calibre-library/      │
│  Calibre Library │                │  Calibre Library/        │
└──────────────────┘                │                          │
   Master copy                      │  Nginx reverse proxy     │
   (add/tag here)                   │  + Let's Encrypt SSL     │
                                    └──────────────────────────┘
                                       Synced copy
                                       (browse/read here)
```
...
* **URL:** https://books.kkpod.dev
* **OPDS Feed:** https://books.kkpod.dev/opds
...
Domain: `books.kkpod.dev` (subdomain of kkpod.dev, pointed at VPS IP)
...
sudo certbot --nginx -d books.kkpod.dev
```
...
1. Open https://books.kkpod.dev in Safari
...
2. Add OPDS catalog: `https://books.kkpod.dev/opds`
...
* Domain: kkpod.dev (shared across projects)
